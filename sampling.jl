function sampling(d1,d2)
    tspan = (0.0,300.0)
    N  = 100
    p  = (5.0 , 5.0, 0.0 , 10.0 , 1.0 , 0.04, d1 , d2) # D1,D2
...
for i=[0.0,0.01,0.025,0.05,0.75,0.1,0.25,0.5,0.75,1.0] 
    @distributed for j=[0.0,0.01,0.025,0.05,0.75,0.1,0.25,0.5,0.75,1.0]
            println(i,j)
            sampling(i,j)
        end
end
